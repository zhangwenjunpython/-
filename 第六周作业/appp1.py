...
fi=open(r"D:\\woking file\\python\\app1.txt",'w')
for i in list:
    fi.write(str(i)+",")     #数字顺序排列，每个数字用逗号隔开
fi.close()

#追加写内容
fo = open('D:\\woking file\\python\\app1.txt','r',encoding='utf-8')
f=fo.read().split(",")
f=f[::-1]
f=f[1:]                    #先读出文件，倒序排序
fo.close()

fire= open('D:\\woking file\\python\\app1.txt','a',encoding='utf-8')
fire.write("\n")
for line in f:
    fire.write(line+",")
